...
- `review-remediation` — INV-12 CLI zeroization, async spec tests (INV-5/6/8), shared unscrub abstraction (process_safe_region), charset O(1) bitmap+static, AC pre-filter, dedup alloc fix; commit 36f8099
